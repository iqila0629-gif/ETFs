"""Phase 4 (M5): fund self-momentum / reversal signals for remaining funds."""
...
REPORT = OUT_DIR / "self_signal_results.csv"
OUTPUTS = OUT_DIR / "sparse_outputs_self"
